...
import { EditableDirectoryList, EditableHomeCta, EditableHomeHero, EditableMagazineSplit, EditableStoryRail, EditableTimeCollections } from '@/editable/sections/HomeSections'
...
export default async function HomePage() {
  ...
  <Ads slot="header" showLabel eager className="mx-auto w-full" />
      ...
      <EditableDirectoryList primaryTask={primaryTask} primaryRoute={primaryRoute} posts={primaryPosts} timeSections={timeSections} />
